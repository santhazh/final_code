...
class QuickVerify extends Component {
  ...
  render() {
    const { handleSubmit, pristine, submitting, submitCase, previousPage } = this.props;
    return (
      <div className="MidContentWrap">
        <div className="">
          <h1> Get Verified Quicker (Optional) </h1>
          <div className="skipOption">
            <a type="submit" onClick={handleSubmit}>Skip</a>
          </div>
        ...
        <div className="formOutterWrap">
          ...
          <form onSubmit={handleSubmit} className='form-style'>
            ...
            <Row>
              <Col lg={3} sm={3} className="expmonth" ><Field name="month" type="number" placeholder="MM" component={renderField} label="Exp. Date" /></Col>
              <Col lg={5} sm={5} className="expyear" ><Field name="year" type="text"  placeholder="YYYY" component={renderField} label="" /></Col>
              <Col lg={4} sm={4}><Field name="cvnumber" type="password" component={renderField} label="CV" /></Col>
            </Row>
            <Row>
              <Col lg={12} sm={12} className="" >
                <Field name="checkbox" type="checkbox" component="input" className="checkmark" /> Use address from business information
    </Col>
            </Row>
            <br />
            ...
            <Row>
              ...
              <Col lg={4} sm={4}><Field name="Zip" type="text" component={renderField} label="Zip" /></Col>
            </Row>
