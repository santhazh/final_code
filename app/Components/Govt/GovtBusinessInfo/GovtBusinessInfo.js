...
const govtBusinessInfo = (props) => {
    ...
    <div className="formOutterWrap">
       <form onSubmit={handleSubmit} className="form-style">
        ...
        <Row><Col lg={3} sm={3}><Field name="phoneText1" type="number" label="PhoneNumber" component={renderField}  validate={[required, positiveValue, minValue(3)]} /></Col>
          <div className="phonetextwrap"><Col lg={3} sm={3}><Field name="phoneText2" type="number"  component={renderField} validate={[required, positiveValue, minValue(3)]} /></Col>
          <Col lg={6} sm={6}><Field name="phoneText3" type="number" component={renderField} validate={[required, positiveValue, minValue(4)]} /></Col>
        </div>
        </Row>
        ...
        <button className="formBtn" type="button" onClick={() => history.push('/login')} >Back</button> 
